         ...
         <div class="col-md-5">
             ...
             <form method="POST" action="{{ route('register') }}">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-md-7">
                         <input id="password" type="password" class="form-control @error('password') is-invalid @enderror samuraimart-login-input" name="password" placeholder="半角記号英数8文字以上" required autocomplete="new-password">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-md-7">
                         <input id="password-confirm" type="password" class="form-control samuraimart-login-input" name="password_confirmation" placeholder="確認の為再度入力" required autocomplete="new-password">
                     </div>
                 </div>
